...
<section class="container-fluid mx-auto d-block">
        <div class="row">
            ...
            <form method="POST" action="<?php echo base_url();?>/index.php/AdminUsuarioR/altaCup" role= "form">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mg">
                        <div class="form-group">
                            <label for="usr">Nombre del Producto</label>
                            <input type="text" name="nomp" id="nomp" value="" required="" class="form-control">       
                        </div> 
                </div> 
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mg"> 
                        <div class="form-group">
                            <label for="email">Categoría del Articulo</label>
                            <input type="text" name="cat" id="cat" value="" required="" class="form-control"> 
                        </div>
                </div>                                          
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mg">
                        <div class="form-group">
                            <label >Precio</label>
                            <input type="text" name="precio" id="precio" value="" required="" class="form-control">      
                        </div>
                        <div class="form-group">
                            <label >Link</label>
                            <input type="text" name="link" id="link" value="" required="" class="form-control">      
                        </div>              
                </div> 
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="dec" id="dec" value="" required="" class="form-control">      
                    </div>
                </div>
