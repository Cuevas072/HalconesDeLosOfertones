<section class="container-fluid">
		...
		<div class="align-content-center justify-content-center col-lg-4 col-md-8 col-sm-12 col-xs-12 colorD conte"><p class="titulo"><br>Actualizar</p>
		<form method="POST" action="<?php echo base_url();?>/index.php/AdminUsuarioA/altaCom" role= "form">
				<div class="form-group">
					 <label >id</label>
					 <input type="number" name="id" id="id" value="" required class="form-control" min="1" max="100" step="1">		
				</div>
